...
| **🧩 Unityz**<br>*(Unity Asset Toolkit)* | [`hordeforge/unityz`](https://github.com/hordeforge/unityz) | *(CLI / Library)* | `Zig` | **Unityz**: Reads, extracts, edits, verifies, and diffs Unity asset files, bundles, and streamed sidecars without the Unity Editor. |
